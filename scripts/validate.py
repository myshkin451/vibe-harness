...
REQUIRED_FILES = [
    ...
    "skills/vibe-harness/scripts/audit.py",
    ...
    "examples/project-types/backend-api.md",
    "examples/project-types/browser-extension.md",
    "examples/project-types/personal-site.md",
    "examples/project-types/saas-tool.md",
